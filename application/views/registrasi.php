                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?php echo base_url('registrasi/index'); ?>">
                                <div class="form-group">
                                    ...
                                    <?php echo form_error('nama', '<div class="text_danger small ml-2">', '</div>'); ?>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username Anda" name="username">
                                    <?php echo form_error('username', '<div class="text_danger small ml-2">', '</div>'); ?>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <?php echo form_error('password_1', '<div class="text_danger small ml-2">', '</div>'); ?>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo form_error('password_2', '<div class="text_danger small ml-2">', '</div>'); ?>
                                    </div>
                                </div>
